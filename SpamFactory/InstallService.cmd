...
sc create SpamFactory binPath= "%~dp0SpamFactory.exe" DisplayName= "SpamFactory Windows Service" start= "auto"
@IF %ERRORLEVEL% NEQ 0 GOTO CREATEFAILURE

sc description SpamFactory "Windows Service part of the SpamFactory application."
