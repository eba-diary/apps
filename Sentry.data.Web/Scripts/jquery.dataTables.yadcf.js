    ...
    var yadcf = (function () {
        ...
        function addRangeDateFilterCapability(table_selector_jq_friendly, fromId, toId, col_num, date_format) {
            ...
            $.fn.dataTableExt.afnFiltering.push(
                function (settingsDt, aData, iDataIndex, rowData) {
                    ...
                    try {
                        /// SENTRY MODIFIED - CHANGED CONDITION FROM === 'bootstrap-datetimepicker' to !== 'jquery-ui'///
                        if (min.length === (date_format.length + 2) || columnObj.datepicker_type !== 'jquery-ui') {
                            if (columnObj.datepicker_type === 'jquery-ui') {
                                min = (min !== "") ? $.datepicker.parseDate(date_format, min) : min;
                            } else { /// SENTRY MODIFIED - REMOVED ELSE IF CONDITION ///
                    ...
                    try {
                        /// SENTRY MODIFIED - CHANGED CONDITION FROM === 'bootstrap-datetimepicker' to !== 'jquery-ui'///
                        if (max.length === (date_format.length + 2) || columnObj.datepicker_type !== 'jquery-ui') {
                            if (columnObj.datepicker_type === 'jquery-ui') {
		...
		*/
        ...
        return {
            ...
            /// SENTRY MODIFIED - ADDED dateSelect ///
