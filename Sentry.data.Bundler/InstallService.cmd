...
sc create Sentry.data.Bundler binPath= "%~dp0Sentry.data.Bundler.exe" DisplayName= "Sentry.data.Bundler Windows Service" start= "auto"
@IF %ERRORLEVEL% NEQ 0 GOTO CREATEFAILURE

sc description Sentry.data.Bundler "Windows Service part of the Sentry.data.Bundler application."
