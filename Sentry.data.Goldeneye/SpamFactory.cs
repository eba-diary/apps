                ...
                using (container = Sentry.data.Infrastructure.Bootstrapper.Container.GetNestedContainer())
                {
                    ...
                    foreach (Event _event in events)
                    {
                        ...
                        *********************************************************************************************************************************/
                        ...
                        //********************************************************************************************************************************/
                        var subsThatMatch = _datasetContext.GetAllSubscriptionsForReal().Where(w => (w as DatasetSubscription)?.Dataset.DatasetId   == _event.Dataset
                                                                                                    && w.EventType.Type_ID                          == _event.EventType.Type_ID
                                                                                                    && w.Interval                                   == _datasetContext.GetInterval(interval));

                        //IEnumerable<Subscription> subscriptions = Query<DatasetSubscription>().Cast<Subscription>();
                        //var s2 = subscriptions.Where(w => (w as DatasetSubscription)?.Dataset.DatasetId == 235 || (w as BusinessAreaSubscription)?.BusinessAreaType == BusinessAreaType.PersonalLines);
