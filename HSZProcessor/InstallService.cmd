...
sc create HSZProcessor binPath= "%~dp0HSZProcessor.exe" DisplayName= "HSZProcessor Windows Service" start= "auto"
@IF %ERRORLEVEL% NEQ 0 GOTO CREATEFAILURE

sc description HSZProcessor "Windows Service part of the HSZProcessor application."
