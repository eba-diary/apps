...
namespace Sentry.data.Infrastructure.FeatureFlags
{
    public class DataFeatures : IDataFeatures
    {
        ...
        public IFeatureFlag<bool> Dale_Expose_EditSensitive_CLA_2025 { get; } = new BooleanFeatureFlag("Dale_Expose_EditSensitive_CLA_2025", configRepo);
        public IFeatureFlag<bool> Dale_Expose_EditUserVerified_CLA_1911 { get; } = new BooleanFeatureFlag("Dale_Expose_EditUserVerified_CLA_1911", configRepo);
