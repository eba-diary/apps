...
namespace Sentry.data.Infrastructure.FeatureFlags
{
    ...
    public class DataFeatures : IDataFeatures, IDisposable
    {
        ...
        public IFeatureFlag<bool> CLA3605_AllowSchemaParguetUpdate { get; }
        ...
        public DataFeatures(UserService userService)
        {
            ...
            CLA3605_AllowSchemaParguetUpdate = new BooleanFeatureFlagAmbientContext("CLA3605_AllowSchemaParguetUpdate", false, LdClient, () => LdUser);
        }
