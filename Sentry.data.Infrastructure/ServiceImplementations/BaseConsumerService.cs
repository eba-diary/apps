...
{
    public abstract class BaseConsumerService<msgT>
    {
        #region Declarations
        ...
        #region Constructors
        protected BaseConsumerService(IMessageConsumer<msgT> consumer, ConsumerConfig config)
        {
            _consumer = consumer;
            _cfg = config;
        }
    ...
    public class ConsumerConfig
    {
        ...
        public ConsumerConfig(bool singleThreaded, bool useKillFile, string killFileLocation, double? runMinutes)
        {
