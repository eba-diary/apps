...
namespace Sentry.data.Infrastructure
{
    public class DaleSearchProvider : IDaleSearchProvider
    {
        ...
        private string BuildAQuery(DaleSearchDto dto)
        {
            ...
            string qSelect = "SELECT Asset_CDE, Server_NME,Database_NME,Base_NME,Type_DSC,Column_NME,Column_TYP,MaxLength_LEN,Precision_LEN,Scale_LEN,IsNullable_FLG,Effective_DTM,Alias_NME,Prod_Typ,BaseColumn_ID,IsSensitive_FLG,IsUserVerified_FLG ";
        ...
        private DaleResultDto CreateDaleResultDto(SqlDataReader reader)
        {
            ...
            {
                result.IsUserVerified = reader.GetBoolean(16);
            }
