...
namespace Sentry.data.Infrastructure
{
    public static class RetrieverJobExtensions
    {
        ...
        public static string GetTargetPath(this DataFlowStep s3DropStep, RetrieverJob executingJob)
        {
            ...
            if (s3DropStep.DataAction_Type_Id != DataActionType.S3Drop && s3DropStep.DataAction_Type_Id != DataActionType.ProducerS3Drop && s3DropStep.DataAction_Type_Id != DataActionType.ProducerS3Drop_v2)
            {
