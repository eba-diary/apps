...
namespace Sentry.data.Infrastructure
{
    ...
    public static class Bootstrapper
    {
        ...
        public static void Init()
        {
            ...
            settings.DefaultMappingFor<DataFlowMetricEntity>(x => x.IndexName(Configuration.Config.GetHostSetting("ElasticIndexFlowMetricSearch")).IdProperty(p=>p.EventMetricId));
