...
--ALTER THE SCRIPT VERSION BELOW FOR EVERY NEW SCRIPT 
--SCRIPT VERSION should be in format yyyy.MM.dd_rr where rr is 2-digit revision number for day. 
--SCRIPT VERSION is DATE YOU PLAN TO DEPLOY!! e.g. 03/25/2020 version 1
SET @ScriptVersion = '2020.03.25.01_PostDeploy'			
...
BEGIN TRY 
  ...
  :r ..\Post-Deploy\SupportingScripts\Sprint_20_02_04\UPDATE_BusinessAreaTile_Hyperlink_URL.sql
