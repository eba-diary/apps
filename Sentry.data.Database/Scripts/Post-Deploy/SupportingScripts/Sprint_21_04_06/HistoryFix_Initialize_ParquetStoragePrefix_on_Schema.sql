SET @ScriptVersion = 'CLA3438_Initialize_ParquetStoragePrefix_on_Schema'
...
BEGIN TRY 
    ...
    UPDATE [Schema]
    SET ParquetStoragePrefix = SUBSTRING(HiveLocation,CHARINDEX('/',HiveLocation,0) + 1, len(HiveLocation))
    where SchemaEntity_NME = 'FileSchema' and ParquetStoragePrefix is null
