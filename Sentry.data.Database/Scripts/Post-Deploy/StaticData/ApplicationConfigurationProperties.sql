BEGIN TRAN
	...
	BEGIN TRY 
		...
		( VALUES 
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'TEST', 'eg.snowflake.proxyHost', 'app-proxy-nonprod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'TEST', 'eg.snowflake.proxyPort', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			...
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUAL', 'eg.snowflake.proxyHost', 'app-proxy-nonprod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUAL', 'eg.snowflake.proxyPort', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'sql.readDatasetFileQuery', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileQuery.ObjectBucket AS [TargetBucket], DatasetFileQuery.ObjectKey AS [TargetKey], DatasetFileQuery.DatasetFileRawID AS [DatasetFileRawID] FROM DatasetFileQuery LEFT JOIN DatasetFileDrop ON DatasetFileQuery.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID WHERE DatasetFileQuery.ObjectStatus = 6;' ),
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'support.database.server', 'dblo-qualnp-plur.dbal.sentry.local' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'support.database.name', 'QUALNP_PLUR' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqualnp.sentry.com' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'snowflake.role', 'BATCH_PLUR_QUALNP' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'snowflake.useProxy', 'true' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'snowflake.proxyHost', 'serverproxyqualnp.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'snowflake.proxyPort', '80' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'eg.snowflake.proxyHost', 'app-proxy-nonprod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'eg.snowflake.proxyPort', '8080' ),
			...
			( 'DFSFILEDETECTORBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqualnp.sentry.com' ),
			...
			( 'DFSTOS3BATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqualnp.sentry.com' ),
			...
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqualnp.sentry.com' ),
			...
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'sql.readDatasetFileQuery', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileQuery.ObjectBucket AS [TargetBucket], DatasetFileQuery.ObjectKey AS [TargetKey], DatasetFileQuery.DatasetFileRawID AS [DatasetFileRawID] FROM DatasetFileQuery LEFT JOIN DatasetFileDrop ON DatasetFileQuery.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID WHERE DatasetFileQuery.ObjectStatus = 6;' ),
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			...
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqualnp.sentry.com' ),
			...
			( 'S3FILESMERGEBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqualnp.sentry.com' ),
			...
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqualnp.sentry.com' ),
			...
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUALNP', 'eg.snowflake.proxyHost', 'app-proxy-nonprod.sentry.com' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUALNP', 'eg.snowflake.proxyPort', '8080' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUALNP', 'eg.ld.proxy.flag', '0' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUALNP', 'eg.ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUALNP', 'eg.ld.proxy.port', '8080' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'PROD', 'eg.snowflake.proxyHost', 'app-proxy-prod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PROD', 'eg.snowflake.proxyPort', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'PROD', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			( 'FILECOPYBATCHHANDLER', 'PROD', 'sql.readDatasetFileQuery', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileQuery.ObjectBucket AS [TargetBucket], DatasetFileQuery.ObjectKey AS [TargetKey], DatasetFileQuery.DatasetFileRawID AS [DatasetFileRawID] FROM DatasetFileQuery LEFT JOIN DatasetFileDrop ON DatasetFileQuery.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID WHERE DatasetFileQuery.ObjectStatus = 6;' ),
			( 'FILECOPYBATCHHANDLER', 'PROD', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			...
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PROD', 'snowflake.role', 'DATA__DBADMIN_ROLE' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'snowflake.role', 'BATCH_PLUR_TEST' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'snowflake.useProxy', 'true' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'snowflake.proxyHost', 'serverproxyprodnp.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'snowflake.proxyPort', '80' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'eg.snowflake.proxyHost', 'app-proxy-prodnp.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'eg.snowflake.proxyPort', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'sql.readDatasetFileQuery', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileQuery.ObjectBucket AS [TargetBucket], DatasetFileQuery.ObjectKey AS [TargetKey], DatasetFileQuery.DatasetFileRawID AS [DatasetFileRawID] FROM DatasetFileQuery LEFT JOIN DatasetFileDrop ON DatasetFileQuery.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID WHERE DatasetFileQuery.ObjectStatus = 6;' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = 1, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT} WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			...
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PRODNP', 'eg.snowflake.proxyHost', 'app-proxy-prodnp.sentry.com' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PRODNP', 'eg.snowflake.proxyPort', '8080' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PRODNP', 'eg.ld.proxy.flag', '0' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PRODNP', 'eg.ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PRODNP', 'eg.ld.proxy.port', '8080' )
