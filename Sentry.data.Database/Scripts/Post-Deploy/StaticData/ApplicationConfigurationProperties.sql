BEGIN TRAN 
	...
	BEGIN TRY 
		...
		( VALUES 
			...
			( 'SNDTESTBATCHHANDLER', 'TEST', 'test.object.bucket', 'sentry-dlst-test-dataset-ae2' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'test.object.key', 'users/data/01/gb_001.csv' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'tarBEGIN TRAN 
	...
	BEGIN TRY 
		...
		( VALUES 
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'TEST', 'snowflake.role', 'PLUR__DEVELOPER_ROLE' ),
			...
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.readDatasetFileQuery', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileQuery.ObjectBucket AS [TargetBucket], DatasetFileQuery.ObjectKey AS [TargetKey], DatasetFileQuery.DatasetFileQueryID AS [DatasetFileQueryID] FROM DatasetFileQuery LEFT JOIN DatasetFileDrop ON DatasetFileQuery.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID WHERE DatasetFileQuery.ObjectStatus = 6;' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = 1 WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			...
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'TEST', 'snowflake.role', 'PLUR__DEVELOPER_ROLE' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUAL', 'snowflake.role', 'PLUR__DEVELOPER_ROLE' ),
			...
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'QUAL', 'snowflake.role', 'PLUR__DEVELOPER_ROLE' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'PROD', 'snowflake.role', 'PLUR__DEVELOPER_ROLE' ),
			...
			( 'SNOWFLAKEREFRESHBATCHHANDLER', 'PROD', 'snowflake.role', 'PLUR__DEVELOPER_ROLE' ),
...
COMMIT TRANget.file.key', 'users/cla4137/sndbatchhandler/target.txt' ),
