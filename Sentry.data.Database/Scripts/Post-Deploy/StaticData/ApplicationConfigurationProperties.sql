BEGIN TRAN
	...
	BEGIN TRY 
		...
		( VALUES 
			...
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.server', 'DLPP-TEST-SentryDatasets.db.sentry.local' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.name', 'SentryDatasets' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.authentication', 'Windows' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.secure.file.path', '' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.failover', '' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.pool.minPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.pool.maxPoolSize', '50' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.pool.initialPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.pool.maxIdelTime', '0' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'support.database.pool.maxStatements', '300' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'data.sentry.rest.base.path', 'https://datatest.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'app.key1', 'value11' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'app.key2', 'value12' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),

			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.server', 'DLPP-TEST-SentryDatasets.db.sentry.local' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.name', 'SentryDatasets' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.authentication', 'Windows' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.secure.file.path', '' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.failover', '' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.pool.minPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.pool.maxPoolSize', '50' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.pool.initialPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.pool.maxIdelTime', '0' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'support.database.pool.maxStatements', '300' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'data.sentry.rest.base.path', 'https://datatest.sentry.com' ),
			...
			( 'SNDTESTBATCHHANDLER', 'TEST', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),
			...
			( 'DFSTOS3BATCHHANDLER', 'TEST', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'DFSTOS3BATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DFSTOS3BATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),
			...
			( 'DSCDISPATCHERBATCHHANDLER', 'TEST', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.readDatasetFileRaw', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileRaw.ObjectBucket AS [TargetBucket], DatasetFileRaw.ObjectKey AS [TargetKey], DatasetFileRaw.DatasetFileRawID AS [DatasetFileRawID] FROM DatasetFileRaw LEFT JOIN DatasetFileDrop ON DatasetFileRaw.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID LEFT JOIN Dataset ON DatasetFileRaw.DatasetID = Dataset.Dataset_ID WHERE DatasetFileRaw.ObjectStatus = 6;' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.readDatasetFileQuery', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileQuery.ObjectBucket AS [TargetBucket], DatasetFileQuery.ObjectKey AS [TargetKey], DatasetFileQuery.DatasetFileQueryID AS [DatasetFileQueryID] FROM DatasetFileQuery LEFT JOIN DatasetFileDrop ON DatasetFileQuery.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID LEFT JOIN Dataset ON DatasetFileQuery.DatasetID = Dataset.Dataset_ID WHERE DatasetFileQuery.ObjectStatus = 6;' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'executorservice.parallelism', '10' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'FILECOPYBATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),
			...
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'TEST', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),

			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.server', 'DLPP-TEST-SentryDatasets.db.sentry.local' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.name', 'SentryDatasets' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.authentication', 'Windows' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.secure.file.path', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.failover', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.pool.minPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.pool.maxPoolSize', '50' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.pool.initialPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.pool.maxIdelTime', '0' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'support.database.pool.maxStatements', '300' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 'data.sentry.rest.base.path', 'https://datatest.sentry.com' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 's3.configuration.bucket', 'sentry-dlst-test-dataset-ae2' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'TEST', 's3.configuration.key', 'conf/query_executor_batch/' ), 
			...
			( 'S3FILESMERGEBATCHHANDLER', 'TEST', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'S3FILESMERGEBATCHHANDLER', 'TEST', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'S3FILESMERGEBATCHHANDLER', 'TEST', 'ld.proxy.port', '8080' ),
			...
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'app.key1', 'value11' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'app.key2', 'value12' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.server', 'dblo-qual-plur.dbal.sentry.local' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.name', 'QUAL_PLUR' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.authentication', 'Windows' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.secure.file.path', '' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.failover', '' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.pool.minPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.pool.maxPoolSize', '50' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.pool.initialPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.pool.maxIdelTime', '0' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'support.database.pool.maxStatements', '300' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'data.sentry.rest.base.path', 'https://dataqual.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),

			( 'SNDTESTBATCHHANDLER', 'QUAL', 'app.key1', 'value21' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'app.key2', 'value22' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'source.object.bucket', 'sentry-dlst-qual-dataset-ae2' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'source.object.key', 'users/data/01/gb_001.csv' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'target.file.key', 'users/cla4137/sndbatchhandler/target.txt' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.server', 'dblo-qual-plur.dbal.sentry.local' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.name', 'QUAL_PLUR' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.authentication', 'Windows' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.secure.file.path', '' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.failover', '' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.pool.minPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.pool.maxPoolSize', '50' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.pool.initialPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.pool.maxIdelTime', '0' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'support.database.pool.maxStatements', '300' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'data.sentry.rest.base.path', 'https://dataqual.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'ld.sdk', 'sdk-ed5ba68e-57e9-425f-b902-41734886628d' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),
			...
			( 'DFSTOS3BATCHHANDLER', 'QUAL', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'DFSTOS3BATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DFSTOS3BATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),
			...
			( 'DSCDISPATCHERBATCHHANDLER', 'QUAL', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			...
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'executorservice.parallelism', '10' ),
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'FILECOPYBATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),
			...
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'QUAL', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),
			
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.server', 'DLPP-QUAL-SentryDatasets.db.sentry.local' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.name', 'SentryDatasets' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.authentication', 'Windows' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.secure.file.path', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.failover', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.pool.minPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.pool.maxPoolSize', '50' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.pool.initialPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.pool.maxIdelTime', '0' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'support.database.pool.maxStatements', '300' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 'data.sentry.rest.base.path', 'https://dataqual.sentry.com' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 's3.configuration.bucket', 'sentry-dlst-qual-dataset-ae2' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUAL', 's3.configuration.key', 'conf/query_executor_batch/' ),
			...
			( 'S3FILESMERGEBATCHHANDLER', 'QUAL', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'S3FILESMERGEBATCHHANDLER', 'QUAL', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'S3FILESMERGEBATCHHANDLER', 'QUAL', 'ld.proxy.port', '8080' ),
			...
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'app.key1', 'value11' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'app.key2', 'value12' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.server', 'dlpp-qualnp-plur.dbal.sentry.local' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.name', 'INTRADAY_PLUR' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.authentication', 'Windows' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.secure.file.path', '' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.failover', '' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.minPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.maxPoolSize', '50' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.initialPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.maxIdelTime', '0' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.maxStatements', '300' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqual.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),

			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'app.key1', 'value21' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'app.key2', 'value22' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'source.object.bucket', 'sentry-dlst-qualnp-dataset-ae2' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'source.object.key', 'users/data/01/gb_001.csv' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'target.file.key', 'users/cla4137/sndbatchhandler/target.txt' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.server', 'dlpp-qualnp-plur.dbal.sentry.local' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.name', 'INTRADAY_PLUR' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.authentication', 'Windows' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.secure.file.path', '' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.failover', '' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.minPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.maxPoolSize', '50' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.initialPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.maxIdelTime', '0' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'support.database.pool.maxStatements', '300' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqual.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),
			...
			( 'DFSTOS3BATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'DFSTOS3BATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DFSTOS3BATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),
			...
			( 'DSCDISPATCHERBATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			...
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'executorservice.parallelism', '10' ),
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'FILECOPYBATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),
			...
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),

			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.server', 'DLPP-QUAL-SentryDatasets.db.sentry.local' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.name', 'SentryDatasets' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.authentication', 'Windows' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.secure.file.path', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.failover', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.pool.minPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.pool.maxPoolSize', '50' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.pool.initialPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.pool.maxIdelTime', '0' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'support.database.pool.maxStatements', '300' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 'data.sentry.rest.base.path', 'https://dataqual.sentry.com' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 's3.configuration.bucket', 'sentry-dlst-qualnp-dataset-ae2' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'QUALNP', 's3.configuration.key', 'conf/query_executor_batch/' ), 
			...
			( 'S3FILESMERGEBATCHHANDLER', 'QUALNP', 'ld.sdk', 'sdk-6dea26fc-9169-4c86-a89f-78b93691a711' ),
			( 'S3FILESMERGEBATCHHANDLER', 'QUALNP', 'ld.proxy.address', 'app-proxy-nonprod.sentry.com' ),
			( 'S3FILESMERGEBATCHHANDLER', 'QUALNP', 'ld.proxy.port', '8080' ),
			...
			( 'FSTTESTBATCHHANDLER', 'PROD', 'app.key1', 'value11' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'app.key2', 'value12' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.server', 'dblo-prod-plur.dbal.sentry.local' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.name', 'PLUR' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.authentication', 'Windows' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.secure.file.path', '' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.failover', '' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.pool.minPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.pool.maxPoolSize', '50' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.pool.initialPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.pool.maxIdelTime', '0' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'support.database.pool.maxStatements', '300' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'data.sentry.rest.base.path', 'https://data.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'PROD', 'ld.proxy.port', '8080' ), 

			( 'SNDTESTBATCHHANDLER', 'PROD', 'app.key1', 'value21' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'app.key2', 'value22' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'source.object.bucket', 'sentry-dlst-prod-dataset-ae2' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'source.object.key', 'users/data/01/gb_001.csv' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'target.file.key', 'users/cla4137/sndbatchhandler/target.txt' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.server', 'dblo-prod-plur.dbal.sentry.local' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.name', 'PLUR' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.authentication', 'Windows' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.secure.file.path', '' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.failover', '' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.pool.minPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.pool.maxPoolSize', '50' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.pool.initialPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.pool.maxIdelTime', '0' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'support.database.pool.maxStatements', '300' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'data.sentry.rest.base.path', 'https://data.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'PROD', 'ld.proxy.port', '8080' ), 
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'PROD', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PROD', 'ld.proxy.port', '8080' ), 
			...
			( 'DFSTOS3BATCHHANDLER', 'PROD', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'DFSTOS3BATCHHANDLER', 'PROD', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'DFSTOS3BATCHHANDLER', 'PROD', 'ld.proxy.port', '8080' ), 
			...
			( 'DSCDISPATCHERBATCHHANDLER', 'PROD', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'PROD', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'PROD', 'ld.proxy.port', '8080' ), 
			...
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'PROD', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'PROD', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'PROD', 'ld.proxy.port', '8080' ), 

			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.server', 'DLPP-PROD-SentryDatasets.db.sentry.local' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.name', 'SentryDatasets' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.authentication', 'Windows' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.secure.file.path', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.failover', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.pool.minPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.pool.maxPoolSize', '50' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.pool.initialPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.pool.maxIdelTime', '0' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'support.database.pool.maxStatements', '300' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 'data.sentry.rest.base.path', 'https://data.sentry.com' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 's3.configuration.bucket', 'sentry-dlst-prod-dataset-ae2' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PROD', 's3.configuration.key', 'conf/query_executor_batch/' ), 
			...
			( 'S3FILESMERGEBATCHHANDLER', 'PROD', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'S3FILESMERGEBATCHHANDLER', 'PROD', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'S3FILESMERGEBATCHHANDLER', 'PROD', 'ld.proxy.port', '8080' ), 
			...
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'app.key1', 'value11' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'app.key2', 'value12' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.server', 'dblo-prod-plur.dbal.sentry.local' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.name', 'PLUR' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.authentication', 'Windows' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.secure.file.path', '' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.failover', '' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.minPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.maxPoolSize', '50' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.initialPoolSize', '10' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.maxIdelTime', '0' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.maxStatements', '300' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'data.sentry.rest.base.path', 'https://data.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'FSTTESTBATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),

			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'app.key1', 'value21' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'app.key2', 'value22' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'prodnp.object.bucket', 'sentry-dlst-prodnp-dataset-ae2' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'prodnp.object.key', 'users/data/01/gb_001.csv' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'target.file.key', 'users/cla4137/sndbatchhandler/target.txt' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.server', 'dblo-prod-plur.dbal.sentry.local' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.name', 'PLUR' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.authentication', 'Windows' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.secure.file.path', '' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.failover', '' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.minPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.maxPoolSize', '50' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.initialPoolSize', '10' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.maxIdelTime', '0' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'support.database.pool.maxStatements', '300' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'data.sentry.rest.base.path', 'https://data.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'SNDTESTBATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),
			...
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'DATABASELOADERPLURBATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),
			...
			( 'DFSTOS3BATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'DFSTOS3BATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'DFSTOS3BATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),
			...
			( 'DSCDISPATCHERBATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'DSCDISPATCHERBATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),
			...
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'sql.updateDatasetFileRaw', 'UPDATE DatasetFileRaw SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileRawID = {DatasetFileRawID};' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'sql.readDatasetFileQuery', 'SELECT DatasetFileDrop.ObjectBucket AS [SourceBucket], DatasetFileDrop.ObjectKey AS [SourceKey], DatasetFileDrop.ObjectVersionID AS [SourceVersionID], DatasetFileQuery.ObjectBucket AS [TargetBucket], DatasetFileQuery.ObjectKey AS [TargetKey], DatasetFileQuery.DatasetFileQueryID AS [DatasetFileQueryID] FROM DatasetFileQuery LEFT JOIN DatasetFileDrop ON DatasetFileQuery.DatasetFileDropID = DatasetFileDrop.DatasetFileDropID LEFT JOIN Dataset ON DatasetFileQuery.DatasetID = Dataset.Dataset_ID WHERE DatasetFileQuery.ObjectStatus = 6 and Dataset.NamedEnvironmentType = ''NonProd'';' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'sql.updateDatasetFileQuery', 'UPDATE DatasetFileQuery SET ObjectStatus = {ObjectStatus}, ObjectVersionID = {ObjectVersionID}, ObjectETag = {ObjectETag}, ObjectSizeAMT = {ObjectSizeAMT}, UpdateDTM = GETDATE() WHERE DatasetFileQueryID = {DatasetFileQueryID};' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'executorservice.parallelism', '10' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'FILECOPYBATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),
			...
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'KAFKACONNECTORTOS3BATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),

			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.server', 'DLPP-PROD-SentryDatasets.db.sentry.local' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.name', 'SentryDatasets' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.authentication', 'Windows' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.secure.file.path', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.failover', '' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.pool.minPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.pool.maxPoolSize', '50' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.pool.initialPoolSize', '10' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.pool.maxIdelTime', '0' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'support.database.pool.maxStatements', '300' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 'data.sentry.rest.base.path', 'https://data.sentry.com' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 's3.configuration.bucket', 'sentry-dlst-prodnp-dataset-ae2' ),
			( 'QUERYEXECUTORBATCHHANDLER', 'PRODNP', 's3.configuration.key', 'conf/query_executor_batch/' ), 
			...
			( 'S3FILESMERGEBATCHHANDLER', 'PRODNP', 'ld.sdk', 'sdk-2c8a53e0-46a8-4b37-9753-418de81db1a2' ),
			( 'S3FILESMERGEBATCHHANDLER', 'PRODNP', 'ld.proxy.address', 'app-proxy-prod.sentry.com' ),
			( 'S3FILESMERGEBATCHHANDLER', 'PRODNP', 'ld.proxy.port', '8080' ),
