BEGIN TRAN 
	BEGIN TRY
		...
		insert into #NewDataActionValues ([Id], [ActionGuid], [Name], [TargetStoragePrefix], [TargetStorageBucket], [ActionType], [TargetStorageSchemaAware], [Description]) values (55, 'BEB9ABBA-6F20-4F8E-9820-041B527D1A5A', 'HR CopyToParquet', 'parquet/', @HRBucket, 'CopyToParquet', 1, 'HR Copies raw parquet file to parquet long term storage within DLST bucket')
		...
		insert into #NewDataActionValues ([Id], [ActionGuid], [Name], [TargetStoragePrefix], [TargetStorageBucket], [ActionType], [TargetStorageSchemaAware], [Description]) values (56, 'E159CA91-A08C-43D4-B2D9-99194DF45153', 'CopyToParquet', 'parquet/', @Bucketv2, 'CopyToParquet', 1, 'Copies raw parquet file to parquet long term storage within DLST bucket')
		...
		BEGIN
			...
			insert into #NewDataActionValues ([Id], [ActionGuid], [Name], [TargetStoragePrefix], [TargetStorageBucket], [ActionType], [TargetStorageSchemaAware], [Description]) values (57, 'FE75F434-33E9-4367-86E0-F55222A661F2', 'HR CopyToParquet', 'parquet/', @HRBucket_NP, 'CopyToParquet', 1, 'HR Copies raw parquet file to parquet long term storage within DLST bucket')
			...
			insert into #NewDataActionValues ([Id], [ActionGuid], [Name], [TargetStoragePrefix], [TargetStorageBucket], [ActionType], [TargetStorageSchemaAware], [Description]) values (58, 'C91F6519-9A5D-4879-A466-B00D3362293D', 'CopyToParquet', 'parquet/', @Bucketv2_NP, 'CopyToParquet', 1, 'Copies raw parquet file to parquet long term storage within DLST bucket')
		END
