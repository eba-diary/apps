...
BEGIN TRAN 
	BEGIN TRY 
		...
		USING (VALUES 
									...
									('CLA3240_UseDropLocationV2','False','CLA3240_UseDropLocationV2','If true, uses the new Producer S3 Drop v2 Data Action Type when creating new Data Flows.  If false, uses the original Producer S3 Drop Data Action Type.')
								)
