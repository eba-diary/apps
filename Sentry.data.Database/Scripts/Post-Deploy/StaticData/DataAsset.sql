...
BEGIN TRAN 
	BEGIN TRY 
		...
		USING (VALUES 
									...
									(2, 'SERAPL', 'SERA PL', 'SERAPLTopology.vsdx', 'SERAPL', NULL, 'SERAPLSupport@sentry.com', 'SERA PL is an Analytical Data Store (ADS) for Personal lines. SERA PL was created to support non-standard auto and personal auto lines of business.', 'SERA PL', 'PL', 'SERA PL.dm1', 1, '065520','078863', 'EAB492DE-13CB-4201-A829-A9FA00C90B40'),
									(3, 'PCRCL', 'PCR CL', 'PCRTopology.vsdx', NULL, NULL, 'PCRProject@sentry.com', NULL, 'PCR CL', 'CL', NULL, 1, '077028','054314', '4B62F049-69F7-4620-99F9-A9FA00C91260'),
									(4, 'PCRPL', 'PCR PL', 'PCRPLTopology.vsdx', NULL, NULL, 'PCRATLASProject@sentry.com', NULL, 'PCR PL', 'PL', NULL, 1, '077028','054314', '5C55E2A2-13E8-4DA2-A97A-A9FA00C91E8C'),
									...
									(10, 'TDM', 'TDM', 'TDMTopology.vsdx', 'TDM', NULL, 'ITTDMSupport@sentry.com', 'The Transportation Data Mart (TDM) is an analytical data store created to support the analysis of the Transportation business unit.', 'TDM', NULL, NULL, 1, '078841','066284', '4D95EA59-FE0B-4C45-AD6A-A9FA00C973C0')
								)
